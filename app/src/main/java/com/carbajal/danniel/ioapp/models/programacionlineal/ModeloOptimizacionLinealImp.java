...
public class ModeloOptimizacionLinealImp {
    ...
    protected ArrayList<Restriccion> restricciones = new ArrayList<>();

    public ModeloOptimizacionLinealImp(){

    }
    public ModeloOptimizacionLinealImp(FuncionObjetivo funcionObjetivo){
