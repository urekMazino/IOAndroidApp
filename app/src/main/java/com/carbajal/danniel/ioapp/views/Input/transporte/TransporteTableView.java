...
public class TransporteTableView extends HorizontalScrollView{

    private TableLayout tableLayout;
    private int variableAmount,restrictionAmount;

    public TransporteTableView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TransporteTableView(Context context, double[][] tablaSimplex, String[] rowNames) {
        super(context);
